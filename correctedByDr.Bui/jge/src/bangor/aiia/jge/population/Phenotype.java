...
/**
 * The class <code>Phenotype&ltT&gt;</code> represents the phenotype of an individual (<code>Individual</code>)
 * of a population (<code>Population</code>).<br>
 * It is a Generic (parameterised type) class which means that its actual value can be of any type.
 * The type parameter &lt;T&gt; specifies the type of the value of the <code>Phenotype</code> object.<br>
 ...
 * @since 	JavaGE 0.1
 * @param	<T> The type of the value of the Phenotype.
 * 			The value must be immutable (either a primitive type or a immutable object).
 */
public class Phenotype<T> implements Cloneable {

	/**
	 * The value of the phenotype.
	 */
	private T value;
	 ...
	 * 
	 * @return Returns the value of the phenotype.
	 */
	public T getValue() {
		return value();
	}
	 ...
	 * 
	 * @param value The value of the phenotype to set.
	 */
	...
	/**
	 * Returns the value of the phenotype. 
	 * Any object which needs to get the value of the phenotype should
	 * use this method.
	 * 
	 * @return Returns the value of the phenotype.
	 */
	...
	/**
	 * Returns the linear string representation of the value of the phenotype. 
	 * Any object which needs to get a linear string representation of the value
	 * of the phenotype must use this method. It calls and returns the <code>toString()</code>
	 * method of the <code>T value</code> object.
	 * 
	 * @return Returns the linear string representation of the value of the phenotype.
	 */
	 ...
	 */
	public Phenotype<T> clone() {		
		return new Phenotype<T>(value());			
	}
